...
Most commonly, reserachers use null hypothesis $\({H}_{0})$ for testing.\The alternate statment is alternate hypothesis $\({H}_{alpha})$\
For example, $\({H}_{0}_)$: Males and females earn equal income.\$\({H}_{alpha})$ Males make more (or less) money than female.\
**Significance Level**\
